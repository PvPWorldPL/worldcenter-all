...
public class TopPlayersNpc implements Runnable {
    ...
    private void updateHologramTopRanking(HologramTrait hologramTrait, String playerName, int playerPoints, int position) {
        ...
        String positionSymbol = switch (position) {
            case 1 -> "➊";
            case 2 -> "➋";
            case 3 -> "➌";
            default -> String.valueOf(position);
        };
        hologramTrait.addLine(ChatUtil.translateHexColorCodes("&8(&#FF9100M&#FF9100i&#FF9100e&#FF9100j&#FF9100s&#FF9100c&#FF9100e &f" + positionSymbol + "&8)"));
    }
    ...
    private void updateHologramTopKill(HologramTrait hologramTrait, String playerName, int playerKills, int position) {
        ...
        hologramTrait.addLine(ChatUtil.translateHexColorCodes("&8(&#E63239M&#E63239i&#E63239e&#E63239j&#E63239s&#E63239c&#E63239e &f" + positionSymbol + "&8)"));
    }

    private void updateHologramTopDeath(HologramTrait hologramTrait, String playerName, int playerMoney, int position) {
        hologramTrait.clear();
        hologramTrait.addLine(ChatUtil.translateHexColorCodes("&8(&f" + playerMoney + "&8)"));
        ...
        hologramTrait.addLine(ChatUtil.translateHexColorCodes("&8(&#FF66FBM&#FF66FBi&#FF66FBe&#FF66FBj&#FF66FBs&#FF66FBc&#FF66FBe &f" + positionSymbol + "&8)"));
    }
    ...
    private void updateHologramTopMonety(HologramTrait hologramTrait, String playerName, String playerBalance, int position) {
        ...
        hologramTrait.addLine(ChatUtil.translateHexColorCodes("&8(&#00FF1CM&#00FF1Ci&#00FF1Ce&#00FF1Cj&#00FF1Cs&#00FF1Cc&#00FF1Ce &f" + positionSymbol + "&8)"));
